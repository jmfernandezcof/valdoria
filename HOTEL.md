...
- Overlay de bienvenida con vídeo de aviso (HeyGen) que informa que el hotel es conceptual; se reproduce con audio por defecto y ofrece controles compactos para silenciar o continuar.
...
- Hero con vídeo de dron en loop (`assets/resort/videos/valdoria-drone.mp4`) sin filtros, overlay ligero y CTA flotante centrado sobre el borde inferior.
...
- Hero con copy curado y navegación consolidada mediante el mismo menú hamburguesa.
- Grid de tarjetas temáticas (Suites, Spa & Wellness, Gastronomía) con imágenes WebP optimizadas.
...
- Galería estática con tres renders en línea (`Suite1.webp`, `Suite2.webp`, `suite3.webp`) replicando el formato cuadrado del antiguo carrusel.
...
- Ajustes recientes: overlay del hero, soporte para vídeo de fondo (`.hero-video`), tarjetas horizontales con fallback vertical, CTA flotante en resort y control de overflow lateral en móviles.
